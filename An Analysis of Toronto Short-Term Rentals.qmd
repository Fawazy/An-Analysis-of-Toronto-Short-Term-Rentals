---
title: "An Analysis of Toronto Short-Term Rentals"
author:
  - name: "Fawaz Yahya"
date: "2025-11-15"
format:
...
```
## Executive Summary
This report examines the factors that influence nightly Airbnb prices in Toronto using data from the Inside Airbnb project[@inside_airbnb] (September 2025). The primary objective is to assess how accommodation capacity, guest review ratings, and neighbourhood-level demand are associated with listing prices.
...
#| fig-cap: "Distribution of Nightly Aribnb Prices"
...
#| fig-cap: "Price vs Accommodation capacity scatterplot"
...
```{r}
#| label: "fig-boxplot"
#| fig-cap: "Price by Neighbourhood Demand Group"
...
#| fig-cap: "Price vs Review Scores Rating"
...
* accommodates: t = 94.67, p < 2e-16 → Reject $H_0$
* review_scores_rating: t = 13.46, p < 2e-16 → Reject $H_0$
* neigh_groupLow: t = -27.00, p < 2e-16 → Reject $H_0$
* neigh_groupMiddle: t = -36.82, p < 2e-16 → Reject $H_0$
...
### Refinement of the Hypothesis Question
...
## Discussion
The regression results provide clear insight into the factors associated with nightly Airbnb prices in Toronto. As shown in (see @tbl-coef), accommodation capacity is the strongest predictor in the model. Holding all other variables constant, listings that can host more guests tend to charge substantially higher prices. This finding is intuitive, as larger properties typically offer more space and amenities, making them more valuable to guests.
...
## Acknowledgment
 OpenAI’s ChatGPT was used to assist with code debugging, table formatting, and grammar refinement during the preparation of this report. All statistical analyses, interpretation of results, and final writing decisions were made by the authors.
